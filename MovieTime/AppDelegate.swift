...
// Notification Code adapted from Workshop Demo Week 10 - Local Notifications by Michael Wybrow at Monash University
...
class AppDelegate: UIResponder, UIApplicationDelegate, UNUserNotificationCenterDelegate {
    ...
    static let CATEGORY_IDENTIFIER = "monash.edu.MovieTime.category"
